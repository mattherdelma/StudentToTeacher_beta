...
function addStudent(username,table,destination)
{
    ...
    var StudentName_code = encodeURI(encodeURI(StudentName));
    ...
    var url="insertonestudent?table="+table+"&StudentId="+StudentId+"&StudentName="+StudentName_code+"&StudentPassword="+StudentPassword+"&StudentClass="+StudentClass+"&StudentCreateTime="+nowtime;
