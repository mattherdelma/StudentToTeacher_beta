...
function addCourse_Class(username,table,destination)
{
    ...
    var KeyId=ClassId+CourseId;
    var url="insertonecourse_Class?table="+table+"&KeyId="+KeyId+"&ClassId="+ClassId+"&CourseId="+CourseId;
    alert(url);
    xmlHttp.open("post",url,true);      //向服务器端发送请求
    xmlHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf8");
    xmlHttp.send("KeyId="+KeyId);
    function callback()
    {
