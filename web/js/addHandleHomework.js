...
function addHandleHomework(username,table,destination)
{
    ...
    var HandleHomeworkCreateTime = nowtime;
    var url="insertonehandlehomework?table="+table+"&HandleHomeworkId="+HandleHomeworkId+"&HomeworkId="+HomeworkId+"&StudentId="+StudentId+"&Title="+Title_code+"&Content="+Content_code+"&HandleHomeworkCreateTime="+HandleHomeworkCreateTime;
    alert(url);
