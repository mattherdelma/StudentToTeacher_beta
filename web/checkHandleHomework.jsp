...
<%@ page import="com.java.code.model.HandleHomework"%>
...
<head>
    ...
    <script type=text/javascript src=js/queryHandleHomeworkInfo.js></script>
...
<% String administorName = (String) session.getAttribute("username");
    ...
    ArrayList newsRealese = jdbc.TeacherQueryAllHandleHomework(administorName);
%>
<body>
<div id="panelwrap">
    ...
    <div class="header">
        ...
        <div class="menu">
            <ul>
                <li><a href="teacher.jsp">主页</a></li>
                <li><a href="checkHandleHomework.jsp" class="selected">检查作业</a></li>
    ...
    <div class="submenu">
        <ul>
            <li><a href="#" >主页</a></li>
            <li><a href="#" class="selected">检查作业</a></li>
            <li><a href="#">布置作业</a></li>
        </ul>
    </div>
            ...
            <div id="right_content">
                ...
                <table id="rounded-corner">
                    ...
                    <%
                        for (int i = 0; i < newsRealese.size(); i++) {
                            HandleHomework tem = (HandleHomework) newsRealese.get(i);
                    %>
                    <tr class="odd">
                        <td><input type="checkbox" name=""/></td>
                        <td><%=tem.getHandleHomeworkId()%>
                        </td>
                        <td><%=tem.getHomeworkId()%>
                        </td>
                        <td><%=tem.getStudentId()%></td>
                        <td><%=tem.getTitle()%></td>
                        <td><%=tem.getHandleHomeworkCreateTime()%></td>
                        <td><a href="#"><img src="images/checkInfo.png" alt="" title="" border="0"
                                             onclick="queryHandleHomeworkInfo('<%=tem.getHandleHomeworkId()%>','HandleHomework')"/></a>
                        </td>
                ...
                <div id="tab1" class="tabcontent">
                    ...
                    <div class="form">
                        <div class="form_row">
                            <label>提交作业Id:</label>
                            <input type="text" class="form_input" id="HandleHomeworkId" value="" readonly/>
                        </div>
                        ...
                        <div class="form_row">
                            <label>学生Id:</label>
                            <input type="text" class="form_input" id="StudentId" value="" readonly/>
                        </div>
                        ...
                        <div class="form_row">
                            <label>作业提交时间:</label>
                            <input type="text" class="form_input" id="HandleHomeworkCreateTime" value="" readonly/>
                        </div>
                        <div class="form_row">
                            <label>作业创建时间:</label>
                        ...
                        <div class="form_row">
                            ...
                            <input type="text" class="form_input" id="OutOfTime" value="" readonly/>
                        </div>
                        <div class="form_row">
                            <input type="submit" class="form_submit" value="作业时限显示" onclick="checkTime('Homework')">
                        </div>
                        <div class="form_row">
                        <input type="submit" class="form_submit" value="检查超时" onclick="check('Homework')">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
