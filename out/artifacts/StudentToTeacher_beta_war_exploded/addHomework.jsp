...
<head>
    ...
    <script type=text/javascript src=js/addHomework.js></script>
</head>
<% String administorName = (String) session.getAttribute("username");
    HomeworkJdbc jdbc = new HomeworkJdbc();
    ArrayList newsRealese = jdbc.AdminQueryAllHomework();
%>
<body>
<div id="panelwrap">

    <div class="header">
        <div class="title"><a href="#">学生作业管理系统（教师版）</a></div>
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="checkHandleHomework.jsp">检查作业</a></li>
                <li><a href="addHomework.jsp" class="selected">布置作业 </a></li>
            </ul>
        </div>
    ...
    <div class="submenu">
        <ul>
            <li><a href="#">主页</a></li>
            <li><a href="#">检查作业</a></li>
            <li><a href="#"  class="selected">布置作业</a></li>
        </ul>
    </div>
        ...
        <div id="right_wrap">
            <div id="right_content">
                ...
                <ul id="tabsmenu" class="tabsmenu">
                    <li class="active"><a href="#tab1">发布新作业</a></li>
                ...
                <div id="tab1" class="tabcontent">
                    ...
                    <div class="form">
                        <div class="form_row">
                            <label>教师Id:</label>
                            <input type="text" class="form_input" id="TeacherId" value='${username}'  readonly/>
                        </div>
                        <div class="form_row">
                            <label>标题:</label>
                        ...
                        <div class="form_row">
                            <label>时限（小时）:</label>
                            <input type="text" class="form_input" id="HomeworkDeadLine" value=""/>
                        </div>

                        <div class="form_row">
                            <input type="submit" class="form_submit" value="提交发布" onclick="addHomework('${username}','Homework','teacher.jsp')">
                        </div>
