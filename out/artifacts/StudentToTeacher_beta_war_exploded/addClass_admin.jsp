<%@ page import="com.java.code.jdbc.StudentClassJdbc"%>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.java.code.model.ClassStudent" %>
...
<% String administorName = (String) session.getAttribute("username");
    StudentClassJdbc jdbc = new StudentClassJdbc();
    ArrayList newsRealese = jdbc.AdminQueryAllStudentClass();
%>
<body>
<div id="panelwrap">
    ...
    <div class="header">
        ...
        <div class="menu">
            <ul>
                <li><a href="addClass_admin.jsp" class="selected">班级</a></li>
    ...
    <div class="submenu">
        <ul>
            <li><a href="#" >主页</a></li>
            <li><a href="#" class="selected">班级</a></li>
            <li><a href="#">学生</a></li>
            <li><a href="#">老师</a></li>
            <li><a href="#">课程</a></li>
        ...
        <div id="right_wrap">
            <div id="right_content">
                ...
                <table id="rounded-corner">
                    ...
                    <tfoot>
                    <tr>
                        <td colspan="12">以上是所有的班级</td>
                    </tr>
                    </tfoot>
                    <tbody>
                    <%
                        for (int i = 0; i < newsRealese.size(); i++) {
                            ClassStudent tem = (ClassStudent) newsRealese.get(i);
                    %>
                    <tr class="odd">
                        ...
                        <td><%=tem.getClassCreateTime()%>
                        </td>
                        <td><a href="#"><img src="images/trash.gif" alt="" title="" border="0"
                                             onclick="javascrtpt:window.location.href = 'deleteoneclass?ClassId=<%=tem.getClassId()%>'"/></a>
                        </td>
                    </tr>
                ...
                <ul id="tabsmenu" class="tabsmenu">
                    <li class="active"><a href="#tab1">创建新班级</a></li>
                ...
                <div id="tab1" class="tabcontent">
                    ...
                    <div class="form">
                        ...
                        <div class="form_row">
                            <label>班级名:</label>
                            <input type="text" class="form_input" id="ClassName">
                        </div>

                        <div class="form_row">
                            <input type="submit" class="form_submit" value="提交发布" onclick="addClass('${username}','Class','addClass_admin.jsp')">
                        </div>
